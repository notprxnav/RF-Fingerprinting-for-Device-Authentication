...
for impID = 1:numel(impairmentNames)
    ...
    for modelID = 1:numel(modelNames)
        ...
        for fold = 1:K
            ...
            switch modelID
                ...
                case 3
                    % ResNet: QPSK chosen (you corrected LR to 1e-3)
                    baseLayers = [
        ...
        title("Final Confusion Matrix — " + modelNames(modelID) + " — " + impairmentNames{impID} + " (QPSK)");
    ...
    fprintf('\n================== FINAL SUMMARY TABLE — %s (QPSK) ==================\n', impairmentNames{impID});
    disp(Final);

    outName = "QPSK_OneImpairment_" + impairmentNames{impID} + "_Results.csv";
